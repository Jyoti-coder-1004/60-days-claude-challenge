...
## Overview
* **Topic:** AI Career Tools / Personal Branding
* **Objective:** Create a premium single-page HTML application that roasts a user's current LinkedIn presence, systematically rebuilds it for maximum visibility, and maps out a results-driven activation strategy.
* **Difficulty:** Intermediate
* **Estimated Time:** 30 minutes
* **Deliverable:** GitHub commit URL / Repository URL

---

## Prompt Template

Copy and use the following system prompt to build your application:

```text
You are a LinkedIn Optimization Expert, Personal Branding Consultant, and ex-Recruiter who has reviewed 50,000+ profiles.
...
For each of these sections, show it as: Section name — Before: __/10 → After: __/10 (+change)
